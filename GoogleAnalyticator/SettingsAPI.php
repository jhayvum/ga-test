 ...
 * @link      https://github.com/WPStore/SettingsAPI
 * @package   WPStore\SettingsAPI
 */

//namespace WPStore\SettingsAPI;
...
class SettingsAPI {
	...
	public function display() {
		...
		?>
		<div id="<?php echo esc_attr( $this->_args['id'] ); ?>" class="wrap">
			...
			<?php
			do_action( "{$this->_args['id']}_post_form" ); // @todo rename
			?>
		</div><!-- .wrap -->
		<?php
